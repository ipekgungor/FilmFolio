...
function init() {
    ...
    function applyHTML() {
        ...
        $("<button type=\"button\" class=\"btn family\" id=\"family\">FAMILY</button><br>").appendTo("#filter");
        $("<button type=\"button\" class=\"btn fantasy\" id=\"fantasy\">FANTASY</button><br>").appendTo("#filter");
        $("<button type=\"button\" class=\"btn horror\" id=\"horror\">HORROR</button><br>").appendTo("#filter");
        $("<button type=\"button\" class=\"btn musical\" id=\"musical\">MUSICAL</button><br>").appendTo("#filter");
        $("<button type=\"button\" class=\"btn sci-fi\" id=\"sci-fi\">SCI-FI</button><br>").appendTo("#filter");
        $("<button type=\"button\" class=\"btn thriller\" id=\"thriller\">THRILLER</button><br>").appendTo("#filter");
    }
